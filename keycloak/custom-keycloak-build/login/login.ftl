    ...
    <div id="kc-form">
	 ...
	 <#if !usernameHidden??>
		...
		<span class="input-group-text">
            ...
            <input kc-password tabindex="2" id="securepass" class="${properties.kcInputClass!} " name="securepass" type="password" placeholder="Password" autocomplete="off"
	    ...
	    <button class="pf-c-button pf-m-control" type="button" aria-label="Show password" onclick="togglePassword()">
		    ...
		    <div class="checkbox">
			<span><a tabindex="5" target="_blank" href="https://cloud.gov.in/help/#/virtualization_platform/opensource_hypervisor/Overview">${msg("helpMe")}</a></span>
                     </div>
            ...
            <#if !locked??>
            <input tabindex="4" class="login-button ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}"/>
            </#if>
        </div>
        </form>
